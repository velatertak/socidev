  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Privacy Settings */}
        <div>
          <h3 className="text-sm font-medium text-gray-900 mb-4">{t('privacySettings')}</h3>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label className="block text-sm font-medium text-gray-700">
              ...
              <div className="relative inline-block w-12 h-6">
                ...
                <div
                  className={`block w-12 h-6 rounded-full transition-colors ${
                    settings.privacy.hideStats ? 'bg-blue-600' : 'bg-gray-200'
                  }`}
                />
                <div
                  className={`absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform transform ${
                    settings.privacy.hideStats ? 'translate-x-6' : 'translate-x-0'
                  }`}
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative inline-block w-12 h-6">
                ...
                <div
                  className={`block w-12 h-6 rounded-full transition-colors ${
                    settings.privacy.privateProfile ? 'bg-blue-600' : 'bg-gray-200'
                  }`}
                />
                <div
                  className={`absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform transform ${
                    settings.privacy.privateProfile ? 'translate-x-6' : 'translate-x-0'
                  }`}
                />
              </div>
            </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700">
                    {t('typeToConfirm', { username: account.username })}
                  </label>
                  <input
                    type="text"
