                  ...
                  <div className='mt-4 space-y-4'>
                    <div className='space-y-2'>
                      ...
                      <input
                        ...
                        className='w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-pink-500 focus:ring-pink-200'
                      />
                    ...
                    <div className='space-y-2'>
                      ...
                      <div className='relative'>
                        ...
                        <input
                          ...
                          className='w-full pl-9 pr-3 py-2 rounded-lg border border-gray-300 focus:border-pink-500 focus:ring-pink-200'
                        />
                      </div>
                    </div>
                ...
                <div className='flex items-center gap-3 mb-2'>
                  <div
                    className={`p-2 rounded-lg ${
                      selectedSpeed === id ? "bg-pink-100" : "bg-gray-100"
                    }`}>
                    <Icon
                      className={`w-5 h-5 ${
                        selectedSpeed === id ? "text-pink-600" : "text-gray-500"
                      }`}
                    />
                  </div>
                  <div>
                    <p
                      className={`font-medium ${
                        selectedSpeed === id ? "text-pink-600" : "text-gray-900"
                      }`}>
                      {name}
                    </p>
